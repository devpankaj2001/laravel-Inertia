        ...
        <div class="rank-hero-dashboard" id="rankHeroDashboard">
          ...
          <div class="serp-preview-card">
            ...
            <div class="serp-rich-row">
              ...
              <span>·</span>
              <span>Global Reach · Worldwide Clients</span>
            </div>
          ...
          <aside class="consult-stage">
            ...
            <div class="consult-stage-inner">
              ...
              <div class="consult-contacts">
                <a href="mailto:{{ config('site.email') }}" class="consult-contact">
                ...
                <a href="tel:{{ preg_replace('/[^0-9+]/', '', config('site.phone')) }}" class="consult-contact">
        ...
        <div class="ai-playgrounds-head">
          <div class="ai-playgrounds-head-copy">
            ...
            <div class="ai-playgrounds-chips">
              ...
              <span class="ai-playgrounds-chip"><i class="fas fa-globe"></i> Global Reach · Worldwide Clients</span>
            </div>
          </div>
          ...
          <div class="ai-playgrounds-stage-inner">
            <div class="ai-play-carousel-wrap">
              ...
              <div id="playgroundCarousel" class="owl-carousel owl-theme ai-play-carousel">
                <div class="item">
                  <a href="{{ route('blogs.show', 'headless-ecommerce-sub-second-checkouts') }}" class="ai-play-card text-decoration-none">
                ...
                <div class="item">
                  <a href="{{ route('blogs.show', 'fintech-seo-technical-compliance-banking-platforms') }}" class="ai-play-card text-decoration-none">
                    <article class="ai-play-card-shell ds-clip-sm">
                      <div class="ai-play-card-browser">
                        <div class="ai-play-card-chrome">
                          <span class="ai-play-card-dot is-red"></span>
                ...
                <div class="item">
                  <a href="{{ route('blogs.show', 'healthcare-medtech-seo-eeat-hipaa-strategy') }}" class="ai-play-card text-decoration-none">
                    <article class="ai-play-card-shell ds-clip-sm">
                      <div class="ai-play-card-browser">
                        <div class="ai-play-card-chrome">
                          <span class="ai-play-card-dot is-red"></span>
                ...
                <div class="item">
                  <a href="{{ route('blogs.show', 'mastering-core-web-vitals-inp-rankings') }}" class="ai-play-card text-decoration-none">
                    <article class="ai-play-card-shell ds-clip-sm">
                      <div class="ai-play-card-browser">
                        <div class="ai-play-card-chrome">
                          <span class="ai-play-card-dot is-red"></span>
            ...
            @foreach($blogs as $blog)
              <div class="item p-2">
                <article class="blog-list-card">
                  <a href="{{ route('blogs.show', $blog->slug) }}" class="blog-list-card-link">
                    <div class="blog-card-box">
                      ...
                      <div class="blog-list-body">
                        <h3 class="blog-grid-title">{{ $blog->title }}</h3>
                        <p class="blog-grid-tags" aria-label="Categories"><span>{{ $blog->category ?? 'Insights' }}</span></p>
                      </div>
                    </div>
                  </a>
                </article>
      ...
      <div class="offices-locations-layout">
        ...
        <div class="offices-locations-map-wrap">
          <div class="offices-loc-detail" id="officesLocDetail">
            ...
            <a class="offices-loc-detail-phone" id="officesLocPhone" href="tel:{{ preg_replace('/[^0-9+]/', '', config('site.phone')) }}">
