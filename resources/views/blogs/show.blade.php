...
@push('styles')
  ...
  <style>
    /* Prominent Theme-Colored Links for Article Content, Backlinks & Contextual Placements */
    .blog-content-body a,
    .prose.blog-content-body a,
    .blog-detail-body-section article a,
    .prose a {
      color: #ff3b30 !important;
      text-decoration: underline !important;
      text-decoration-color: rgba(255, 59, 48, 0.55) !important;
    ...
    .prose.blog-content-body a:hover,
    .blog-detail-body-section article a:hover,
    .prose a:hover {
    ...
    /* Hero Text Contrast on Dark Navy Background */
    .blog-detail-hero .blog-aiero-title,
    .blog-aiero-title {
      color: #ffffff !important;
      text-shadow: 0 2px 10px rgba(0, 0, 0, 0.35);
    }
    .blog-detail-hero .blog-detail-hero-deck {
      color: #cbd5e1 !important;
    }
    .blog-detail-hero .blog-aiero-crumb a {
      color: #94a3b8 !important;
    }
    .blog-detail-hero .blog-aiero-crumb a:hover {
      color: #ff3b30 !important;
    }
  </style>
@endpush
